          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pb-16 border-b border-slate-800">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4 text-sm font-medium">
                <li><Link to="/courses" className="hover:text-indigo-400 transition-colors">探索地图</Link></li>
                <li><Link to="/tools" className="hover:text-indigo-400 transition-colors">大师工具</Link></li>
                <li><a href="#" className="hover:text-indigo-400 transition-colors">基础乐理</a></li>
                <li><a href="#" className="hover:text-indigo-400 transition-colors">曲谱库</a></li>
              </ul>
            </div>
          </div>
